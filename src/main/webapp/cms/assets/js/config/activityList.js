$(function() {
    ...
    var listTableUrl = config.base_server + config.activityListUrl;
    ...
    var tableIns = layui.table.render({
        ...
        cols: [
            [{field: 'id', sort: true, title: '编号', width: 100, fixed: 'left'},
                {field: 'link', sort: true, title: '详情页地址', width: 320},
                {field: 'name', sort: true, title: '活动名称', width: 250},
                {field: 'img', sort: true, title: '图片地址', width: 300},
                {field: 'dsc', sort: true, title: '活动说明', width: 100},
    ...
    //工具条点击事件
    layui.table.on('tool(activityList)', function (obj) {
        var data = obj.data;
